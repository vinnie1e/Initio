...
Create:
1. "title": A matching, highly thematic title for the quest (e.g. "The Obsidian Citadel" for Fantasy, "Mainframe Protocol 9" for Sci-Fi, "Case of the Wet Pavement" for Noir, "A Warm Hearth & Baked Bread" for Cozy, or matching whatever custom theme they described)
2. "intro": A short thematic introduction story paragraph (under 80 words) describing the setting and how the summit goal is the ultimate prize or core objective.
3. "genre": You MUST classify this story's theme/setting into one of these four exact categories: "Fantasy", "Sci-Fi", "Noir", or "Cozy" (whichever fits the visual tone best).
4. "chapters": An array of objects, one for each task in order. Each object must have:
   - "task": The exact original task title
   - "line": A highly atmospheric narrative sentence framing this specific task as a trial, hack, lead, or cozy chore. Include the task title naturally but make the wording deeply stylized to the genre.
          ...
          responseSchema: {
            ...
            properties: {
              ...
              genre: {
                type: Type.STRING,
                description:
                  "Must be one of: 'Fantasy', 'Sci-Fi', 'Noir', or 'Cozy'",
              },
              chapters: {
                type: Type.ARRAY,
                items: {
