...
export default function App() {
  ...
  return (
    <>
      ...
      <div className="wrap" style={{ padding: isMobile ? "10px" : "24px", maxWidth: currentMode === "mobile" ? "420px" : currentMode === "tablet" ? "880px" : "1200px", margin: "0 auto", transition: "all 0.3s ease" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontSize: 13, fontWeight: 500, color: "var(--text)" }}>
            Layout Mode: <strong style={{ color: "var(--flow)" }}>{deviceMode.toUpperCase()}{deviceMode === "auto" ? ` (${currentMode})` : ""}</strong>
          </span>
          {(deviceMode === "auto" || deviceMode === "desktop") && <span style={{ fontSize: 11, color: "var(--muted)" }}>(Responsive: {windowWidth}px)</span>}
        </div>
        <div style={{ display: "flex", gap: 6, width: isMobile ? "100%" : "auto", justifyContent: isMobile ? "center" : "flex-end" }}>
          {(["auto", "desktop", "tablet", "mobile"] as const).map((m) => (
            <button
              key={m}
      ...
      <div style={{
        border: (currentMode === "mobile" || currentMode === "tablet") ? "8px solid rgba(255, 255, 255, 0.08)" : "none",
        borderRadius: currentMode === "mobile" ? "32px" : currentMode === "tablet" ? "20px" : "0px",
        padding: (currentMode === "mobile" || currentMode === "tablet") ? (isMobile ? "12px 10px" : "20px 16px") : "0px",
        background: (currentMode === "mobile" || currentMode === "tablet") ? "rgba(10, 10, 15, 0.4)" : "transparent",
        boxShadow: (currentMode === "mobile" || currentMode === "tablet") ? "0 20px 50px rgba(0,0,0,0.5)" : "none",
        minHeight: currentMode === "mobile" ? "780px" : currentMode === "tablet" ? "1000px" : "auto",
...
function TasksView({ tasks, onFocus, onRescue, onComplete, onMiss, onLogEnergy, isMobile, gtasks, onSyncTasks, onImportTask }: any) {
  return (
