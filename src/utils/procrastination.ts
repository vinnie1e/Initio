...
export function detectProcrastinationPatterns(
  ...
  if (streak > 5) {
    score -= 15;
    insights.push("Initio Advantage: Your streak is fueling low-friction start rituals. The Pavlovian tone works because your brain associates it with completion.");
  }
